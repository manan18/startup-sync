...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ name, username, description, image }) => {
    return (
        <div className='flex flex-col border max-w-[500px] rounded-lg gap-4 p-4 shadow-md justify-center bg-slate-100'>
...
const HeroCard = () => {
    return (
        <div className='col-span-2 row-span-2 m-4 border rounded-lg shadow-lg p-6 flex flex-col justify-center bg-white'>
