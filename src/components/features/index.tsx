...
const Features = () => {
    return (
        <div className="bg-[#0353a4] w-full px-10">
            <div className="mx-auto sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:pb-10 lg:pt-10  lg:px-8 ms-10">
                <div>
                    <h2 className="text-lg font-semibold text-slate-200">Seamless Startup Management</h2>
                    <p className="mt-2 text-3xl font-bold tracking-tight text-white">All-In-One Platform</p>
                        ...
                        {features.map((feature) => (
                            <div key={feature.name} className="relative">
                                <dt className='flex gap-4 items-center'>
                                    ...
                                    <p className="text-lg font-medium leading-6 text-slate-100">{feature.name}</p>
                                </dt>
                                <dd className="mt-2 ml-9 text-base text-slate-300">{feature.description}</dd>
                            </div>
                        ))}
                    </dl>
                </div>
