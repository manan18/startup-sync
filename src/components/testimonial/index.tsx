...
const Testimonial = () => {
  return (
    <div
      className="flex flex-col gap-3 p-10 bg-[#0353a4]"
      suppressHydrationWarning
    >
      <div className="text-center ">
        <h1 className="text-3xl font-bold tracking-wide text-white p-2">
          Voices of Triumph
        </h1>
        <p className="tracking-wide text-slate-200 text-xl p-1">
